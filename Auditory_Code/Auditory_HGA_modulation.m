...
for side = {'Rt','Lt'}
    for t = 1:numel(list)
        ...
        for k = 1:34
            CI = []; 
            bin_width = 5;
            dname1  = ['C:\Project_AP\Auditory\1_Group_Data\Group_' n2 '_Dataset.mat'];
            savedir = ['C:\Project_AP\Auditory\3_HGA_modulation\Auditory_' n2 '\'];
            ...
            switch Condition
                ...
                case 'Stim_off'; Tmin = -2600; Tmax = 1400;  bin = 1:801;
            end
            Twindow    = Tmin:5:Tmax;
