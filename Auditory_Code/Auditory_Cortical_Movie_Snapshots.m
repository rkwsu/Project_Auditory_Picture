...
conditions = {'Stim_off'}; %'Stim_on', 'Resp_on', 'Stim_off'
datasets = {'Group_Stim_off_Dataset.mat'}; %'Group_Stim_on_Dataset.mat', 'Group_Resp_on_Dataset.mat', 'Group_Stim_off_Dataset.mat'
movie_time_ranges = {[-500 500]};
snapshot_times = { [ 0 ]};

for condIdx = 1:length(conditions)
    savedir = (['C:\Project_AP\Auditory\2_Cortical_Movie\\' conditions{condIdx}]);
    ...
    % *** 
    data1 = load(['C:\Project_AP\Auditory\1_Group_Data\\' datasets{condIdx}]); % Left 3D brain
    data2 = load(['C:\Project_AP\Auditory\1_Group_Data\\' datasets{condIdx}]); % Right 3D brain
