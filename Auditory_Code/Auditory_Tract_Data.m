...
%-------------------------------------------------------------
bands   = {'HG'};
tasks   = {'Stim_on','Resp_on','Stim_off'};
stat    = '9999CI';         
method  = 'both';            
NF      = '1000';
NS      = '500000';
...
for b = 1:numel(bands)
    ...
    for t = 1:numel(tasks)
        task    = tasks{t};
        datadir = [rootDir 'Auditory\4_FC_modulation\Auditory_' task '\'];
        savedir = [rootDir 'Auditory\5_Dynamic_Tractography_Data\Auditory_' task '\'];
...
% 
    ...
    for band = bands
        ...
        task=cell2mat(tasks(t2));
            ...
            datadir=(['C:\Project_AP\Auditory\4_FC_modulation\Auditory_' task '\']);
            tractdir= ['C:\Project_AP\Auditory\5_Dynamic_Tractography_Data\Auditory_' task '\'];
            savedir=(['C:\Project_AP\Auditory\6_Dynamic_Tractography_Movie_Data\Auditory_' task '\']);
